...
// ---------------------------------------------------------------------------
// Casting choices for this Editor's Choice story
// ---------------------------------------------------------------------------
const CHOICES = [
...
// The situation gets its own featured treatment
...
export default function Listen() {
  useSEO({
    ...
    description:
      "Hear what a private, personalised audio story sounds like. An Editor's Choice After Dark story — then create one built entirely around your own choices.",
  });
  ...
  useEffect(() => {
    ...
    const onMeta = () => {
      ...
      if (d && isFinite(d) && d > 0) {
        setDuration(d);
        // Seek to Scene 3 once we know the duration
        if (!seeked) {
  ...
  // Progress relative to the whole story
  const progress = duration ? (currentTime / duration) * 100 : 0;
  // Scene 3 marker position on the bar
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center px-6 pb-10 max-w-lg mx-auto w-full">
          ...
          {/* After Dark + Editor's Choice badges */}
          <motion.div
          ...
          >
            <p className="text-[10px] font-bold text-primary/70 uppercase tracking-widest mb-2">
              Forbidden · 10 min · Narrated by Clara
            </p>
          ...
          >
            ...
            {/* Progress bar with Scene 3 marker */}
            <div
