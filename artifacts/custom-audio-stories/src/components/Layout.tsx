    ...
    <footer className="border-t border-border/40 bg-background/50 pt-14 pb-10 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-border/20 pt-8 flex flex-col items-center text-center">
          <div className="mb-3">
            <LogoFull height={140} className="mx-auto" />
          </div>
          ...
          <p className="text-[11px] text-muted-foreground/30">What you listen to here stays here. Always. · The Private Story operates through a company registered in England &amp; Wales.</p>
        </div>
      </div>
    </footer>
  );
