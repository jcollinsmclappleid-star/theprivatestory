...
export const forcedProximityRomanceAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
    ...
    { q: `How do I create a forced proximity story?`, a: `In the Casting Room at The Private Story, you choose the pairing, the chemistry, the character archetype, the setting, the emotional intensity, the mood, and the situation. To create a forced proximity story, select a situation from the dramatic categories that involves shared space — or use the detailed situation selector to specify the exact constraint you want. The story is generated around your choices and narrated in the voice you select. The creation flow takes under two minutes; the story is ready to listen shortly after.` },
  ],
};
