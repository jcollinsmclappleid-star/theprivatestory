...
export { MiniDoorCTA } from "@/components/MiniDoorCTA";
export { MAIN_FUNNEL_DOOR };
...
const DOORS = [
  {
    id: "dark",
    room: "The Story Room",
    name: "After Dark — Fantasies",
    shortName: "After Dark",
    tagline: "Explicit, unrestrained erotic fiction — private, dark, and entirely yours.",
    ...
    teasers: [
      { text: "Power exchange. Dominance. Surrender on your terms.", blur: false },
      { text: "She gave him control. He used every second of it.", blur: false },
      { text: "Every detail written. Nothing held back.", blur: true },
    ],
    moodImages: [
