...
const STEP_CARDS = [
  ...
  },
  {
    ...
    options: ["Tender", "Heated", "Deeply Intimate", "Scorching"],
    optionSubs: ["Emotional, slow burn", "Desire building, charged", "Fully rendered", "At full depth"],
    selected: "Heated",
    example: null,
    isSetting: false,
    isFinal: false,
  ...
  },
  {
    ...
    options: ["Forbidden", "Urgent", "Dark", "Desperate", "Decadent", "Wicked", "Breathless", "All-Consuming", "Burning", "Reckless"],
    selected: "Forbidden",
    example: null,
    isSetting: false,
    isFinal: false,
