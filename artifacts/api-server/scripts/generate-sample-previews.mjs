...
const SAMPLES = [
  ...
  },
  {
    ...
    label: "The Supervisor's Office (Elena = Clara stand-in)",
    segments: [
      { voice: "kayla", text: "The report was still open. Neither of them was reading it." },
      { voice: "maya",  text: "You're not looking at the page." },
      { voice: "elena", text: "No." },
      { voice: "maya",  text: "What are you looking at?" },
      { voice: "elena", text: "You. The way you've been sitting across from me for three years pretending you don't feel this." },
      { voice: "maya",  text: "I never said I didn't feel it." },
      { voice: "elena", text: "Then say what you do feel. Right now. Just us." },
      { voice: "maya",  text: "I want you to touch me." },
      { voice: "elena", text: "Here?" },
      { voice: "maya",  text: "Yes. Here. I have wanted it every single Friday." },
      { voice: "elena", text: "And I have spent every single Friday not doing it." },
      { voice: "maya",  text: "Then stop being good." },
      { voice: "kayla", text: "She stood. Crossed the room. Her supervisor finally — finally — moved." },
    ],
  },
];
