...
export const usersTable = pgTable("users", {
  ...
  subscriptionPlan: text("subscription_plan", { enum: ["free", "monthly", "annual", "immersive", "pack_1", "pack_5", "pack_20"] }).notNull().default("free"),
  ...
  // One-time credit pack credits — used by pack_1/pack_5/pack_20 plans; never expire
...
export const pendingPurchasesTable = pgTable("pending_purchases", {
  ...
  plan: text("plan", { enum: ["monthly", "annual", "immersive", "pack_1", "pack_5", "pack_20"] }).notNull(),
  stripeSubscriptionId: varchar("stripe_subscription_id"),
