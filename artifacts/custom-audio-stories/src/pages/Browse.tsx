...
export default function Browse() {
  ...
  const { data: stories, isLoading } = useStoriesFallback(activeMood !== "All" ? { mood: activeMood } : undefined);
  ...
  return (
    ...
    >
      <div className="mb-12">
        ...
        <p className="text-muted-foreground text-sm mb-6">Curated stories, ready to play.</p>
        ...
        <>
          ...
          {stories?.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-muted-foreground text-lg">No stories found for this mood.</p>
              <p className="text-muted-foreground/60 text-sm mt-2">Try a different filter or check back soon.</p>
            </div>
          )}
        </>
      )}
