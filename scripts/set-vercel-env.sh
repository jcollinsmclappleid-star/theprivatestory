...
# Preview-only QA bypass (optional — do not enable on production)
# add_env "VITE_BYPASS_PAYWALL" "true"
# add_env "STAGING_BYPASS_PAYWALL" "1"
# add_env "STAGING_BYPASS_USER_ID" "qFysTO4112Zx45CUhlIb2fy8Z0oje55d"
