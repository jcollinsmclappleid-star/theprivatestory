 ...
 *
 * Editorial standard: every transcript fades before any explicit content.
...
export const EDITORS_PICKS: EditorsPick[] = [
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 130,
    transcript: `She had stayed late on purpose. She told herself it was the quarterly close, but the quarterly close had finished an hour ago and she was still at her desk because she had heard him say, that morning, that he might come back to pick something up.
...
The lock turned.`,
  },
  {
    ...
    pairing: "Her & Him & Him",
    runtimeSec: 140,
    transcript: `The snow had started at four. By eight, it was clear no one was driving anywhere. The cabin had one bedroom, and a sofa long enough for one man, and three of them — her, and the two men she had known since university, the two men who had, separately, in the years since, both told her things they shouldn't have told her.
...
She left the door open behind her.`,
  },
  {
    ...
    endsOn: "the key turns in the lock.",
...
She did not move from the door.`,
  },
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 140,
    transcript: `He had been hired six weeks ago. He stood in the corner of every room she was in. He drove behind her car. He was at the end of every corridor. He had, in six weeks, said perhaps forty words to her in total.
...
She watched him wait.`,
  },
  {
    ...
    endsOn: "she stands. She does not say yes.",
