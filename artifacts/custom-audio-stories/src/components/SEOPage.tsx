...
const TRUST_ITEMS = [
  ...
  { icon: <Heart className="w-4 h-4" />, label: "Designed for the female imagination", sub: "Built around female desire, emotional pacing, and private pleasure", colSpan: true },
];
      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="mb-12 space-y-4 text-muted-foreground text-base leading-relaxed border-l-2 border-primary/30 pl-5">
          ...
          <p>
            ...
            Designed for the female imagination — for anyone who wants private, emotionally intelligent audio storytelling personalised around their mood and tone, not retrieved from a fixed library.
          </p>
          <p>
