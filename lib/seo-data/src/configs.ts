...
export const adultAudioStoriesConfig: SEOPageConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Stories run to around 10 minutes, depending on voice selection — long enough to build properly, short enough to be a complete listening experience in a session. Adult audio fiction for adults with full lives who want the experience to be what it is rather than a significant time commitment.",
      ],
    },
  ],
  howItWorks: [
  ...
  faqs: [
      ...
      { q: `What does a subscription include?`, a: `The standard monthly plan includes five stories per month at £19.99/month, with an annual plan available at £149/year (equivalent to fifty stories). Additional stories can be created at £3.99 each beyond the plan allowance. All stories are narrated, include a generated cover image, and are stored in your private library indefinitely.` },
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The generation produces narrative: the story itself. That story is then narrated — producing audio that is ready to play, that sounds like a story being told rather than text being read, that lands in your ear the way a story is supposed to land.",
...
export const alternativesToRomanceAudiobooksConfig: SEOPageConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "The length — a complete romantic experience in around 10 minutes, not hours, sized for your evening",
      ],
    },
    {
      ...
      bullets: [
        ...
        "You have around 10 minutes rather than many hours",
  ...
  benefits: {
    ...
    items: [
      ...
      {
        heading: "Complete in around 10 minutes",
  ...
  faqs: [
      ...
      { q: `What if I want a romantic story but not a full audiobook?`, a: `This is precisely the gap personalised romance audio stories fill. Stories on The Private Story run around 10 minutes, depending on voice selection — complete romantic experiences in the time available for an evening listening session. They are not excerpts or chapters from longer works. They are complete stories, sized for the specific window when most adults want a romantic audio experience.` },
      ...
      { q: `How long are romantic personalised audio stories?`, a: `Stories typically run around 10 minutes, depending on voice selection — the right length for a complete romantic experience in the wind-down hour, the pre-sleep session, or quiet time alone. Short enough to fit easily into an evening; long enough to build properly and arrive somewhere.` },
    ],
  comparisonTable: {
    ...
    rows: [
      ...
      { feature: "Price", thePrivateStory: "From £19.99/month for 5 personalised stories", other: "£7.99–£14.99/month; popular titles cost extra credits" },
    ],
  },
};
...
export const audioStoriesForWomenConfig: SEOPageConfig = {
  ...
  faqs: [
      ...
      { q: `What does a subscription cost?`, a: `The monthly plan is £19.99/month for five stories. The annual plan is £149/year, which covers fifty stories — equivalent to £2.98 per story. Additional stories beyond your plan allowance are £3.99 each. All plans include full narration, generated cover images, and permanent storage in your private library.` },
...
export const audioStoriesVsAudiobooksConfig: SEOPageConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Choose a personalised audio story when you have around 10 minutes rather than many hours",
      ],
    },
  ],
  howItWorks: [
  ...
  faqs: [
      ...
      { q: `Are personalised audio stories shorter than audiobooks?`, a: `Yes. Personalised audio stories typically run around 10 minutes, depending on voice selection — designed for the specific listening windows where they work best. Audiobooks run anywhere from six to twenty-plus hours. The difference in length reflects a difference in purpose: audiobooks are for sustained engagement, personalised audio stories are for specific emotional experiences in the time you have available.` },
      ...
      { q: `How long does a personalised audio story take to create?`, a: `The creation process — choosing your mood, tone, and preferences — takes less than two minutes. Your story is then generated and ready to listen to shortly after. The story itself runs around 10 minutes, depending on voice selection depending on your selections.` },
    ],
  comparisonTable: {
    ...
    rows: [
      ...
      { feature: "Length", thePrivateStory: "around 10 minutes, depending on voice selection per story", other: "6–20+ hours per title" },
...
export const audioStoriesVsPodcastsConfig: SEOPageConfig = {
  ...
  comparisonTable: {
    ...
    rows: [
      ...
      { feature: "Length", thePrivateStory: "around 10 minutes, depending on voice selection — complete in one session", other: "20–90 minutes; often left partially listened" },
...
export const createYourOwnAudioStoryConfig: SEOPageConfig = {
  ...
  faqs: [
      ...
      { q: `Is creation free or paid?`, a: `Creating personalised audio stories requires a subscription. Plans start at £19.99 per month for five creations, with an annual option at £149 per year for fifty creations. Individual stories can also be purchased for £7.99 each.` },
...
export const relaxingAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
      ...
      { q: `How long are relaxing audio stories?`, a: `Stories are typically around 10 minutes, depending on voice selection. For most adults, this is long enough to fully decompress and, for bedtime listening, to arrive at the edge of sleep. Your story is saved to your account so you can return to it, resume it, or begin a new one whenever you need.` },
...
export const sleepAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
      ...
      { q: `How long should a sleep story be?`, a: `Long enough to carry you to sleep — which varies by person and by night. The Private Story generates stories typically around 10 minutes, depending on voice selection. For most adults, this is the window within which sleep arrives when the conditions are right. If you want to continue listening, your story is saved in your account.` },
...
export const slowBurnAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
      ...
      { q: `How long does the tension last before the payoff?`, a: `This depends on the scenario and the specific story created for your session. Stories typically run around 10 minutes, depending on voice selection, and the arc of tension within that time is shaped by the premise you chose. The story understands that the tension needs to be genuinely sustained — not resolved prematurely — and is generated to deliver that experience rather than rush toward its conclusion.` },
...
export const audioEroticaForWomenConfig: SEOPageConfig = {
  ...
  sections: [
    ...
    {
      h2: "The Psychology of Audio Intimacy — Why Voice Works for Women",
      paragraphs: [
        "Voice is not simply one sensory channel among many. It is the most emotionally communicative of all — carrying more information about the speaker's internal state than any other medium of human communication. The acoustic properties of speech encode emotion, intention, and subtext through prosody: the rhythm, pitch, pace, and tonal texture of voice that delivers not just the content of what is said but everything beneath it. Text strips this out entirely. Visual media compresses it into one element among many. Audio preserves it whole.",
    ...
    {
      h2: "What the Market Has Got Wrong About Female Desire",
      paragraphs: [
        "The dominant industry assumption about female erotic content is that women want less explicit material with more romantic framing. This assumption has shaped the audio erotica market since its beginnings — platforms built for female audiences have consistently calibrated toward softer, slower, more emotional content, treating 'for women' as effectively synonymous with 'less intense'. The market has been solving the wrong problem.",
    ...
    },
    {
      ...
      paragraphs: [
        "For women specifically, the privacy requirement in erotic content is not simply a security preference. Female sexuality has been subject to cultural judgement and social policing in a way male sexuality has not — the legacy of this is that for many women, having erotic preferences exposed feels qualitatively more threatening than the equivalent exposure does for most men navigating the same disclosure. Platform design that creates implicit public records of female erotic preference is not just inconvenient. For a significant proportion of female listeners, it is a genuine structural barrier to exploration.",
        "Most audio erotica platforms create these records without designing for this problem. Public recommendation feeds that surface what you responded to. Review systems that leave a trace of your engagement. Social features borrowed from general entertainment platforms that were never designed for content with these privacy requirements. The 'listeners also liked' engine is not a neutral feature — it turns your private response to content into data that shapes what others see you associated with.",
        "The Private Story was designed without these features. There are no social features, no public recommendation engine, no review system, no activity feed. The features that create implicit public records of erotic preference do not exist on the platform — not as a setting you can disable, but as structural absences. Your creation choices, your listening history, and the content itself exist in your account and are not accessible in any way that could surface them elsewhere. <a href=\"/privacy\">Read the full privacy commitment</a> to understand what this means in practice.",
      ],
    },
  ],
  howItWorks: [
  ...
  scenarios: {
    h2: "What Your Story Can Feel Like",
    intro: "Audio erotica for women takes many different emotional forms. These four are distinct from the story-specific scenarios on the erotic stories page — they describe the quality of the listening experience rather than a narrative situation.",
    items: [
      {
        heading: "The power differential — confidence without performance",
        body: "A character who holds the dynamic through presence rather than display. Their desire is assured — specific in what it wants and clear in how it communicates — but the confidence is not performed for effect. It is the particular quality of someone who is fully in the moment with you, whose attention does not wander, who knows what they want and moves toward it without making a show of the knowing. The power dynamic is real, and it is felt in every exchange, and it is comfortable because it is honest.",
      },
      {
        heading: "The slow-reveal — intimacy through observation",
        body: "A story where the erotic charge builds through being seen accurately. A character who notices the specific things about you that matter — how you speak when you are uncertain, what you reach for when you are nervous, the particular way you pay attention to things you find beautiful. The charge is built from the quality of the observation before anything else. Being known in the right way, with the right attention, is one of the most reliably erotic experiences in fiction for women — and in audio, the specificity of the voice makes it fully land.",
      },
      {
        heading: "The second chance — old feeling, changed context",
        body: "Two people with a history of unresolved desire, finding each other in a situation that has changed. The charge is built from what was never finished — the feeling that was real at the time and did not go anywhere, now present in a context where it is possible to find out whether it is still what it was. The tension is not between strangers but between people who have a particular kind of knowledge of each other, and a particular kind of remaining question. See <a href=\"/forbidden-romance-audio-stories\">forbidden romance audio stories</a> for stories in related registers.",
      },
      {
        heading: "The wrong moment — desire that doesn't respect logistics",
        body: "The specific charge of attraction that arrives in a context where it should not — the timing is wrong, the situation resists it, the sensible response is to pretend it is not what it is. The dynamic is driven by a feeling that does not respond to practical objections. Not forbidden in the sense of rules being broken, but in the sense of inconvenient timing, an impossible context, a pull that exists despite everything that would argue against it.",
      },
    ],
    interstitial: "Your creation choices shape the specific register of the story. These are orientations, not fixed categories — a starting point for a story created around what you actually want to feel.",
  },
  benefits: {
  ...
  faqs: [
    {
      q: "Why is audio specifically effective for erotic content — compared to visual or written erotica?",
      a: "Audio preserves everything that text strips out: the emotional texture of voice, the prosodic signals of desire and intention, the specific quality of how something is said rather than just what is said. Visual content goes in the opposite direction — it provides everything, which means your imagination has nothing to do. Audio sits exactly between these: the voice delivers, your imagination builds. In headphones, the voice is inside your experience rather than outside it — which creates a quality of psychological intimacy that visual media cannot replicate. For women specifically, this convergence of emotional voice processing, imaginative engagement, and interiority is part of why audio erotica works as well as it does.",
    },
    {
      q: "Do I need headphones, or does it work on speakers?",
      a: "The experience is categorically different on headphones. When listening on speakers, the sound is external — in the room with you, audible to others if they're nearby, and without the interiority that makes audio erotica distinctively intimate. Headphones locate the voice inside your experience: it is not something you are observing, it is something you are inhabiting. Most listeners find the headphone experience significantly more effective for the same reason that phone calls feel more intimate than speakerphone conversations.",
    },
    {
      q: "What are the voices like — is this AI narration?",
      a: "Yes — production-grade AI narration voices, selected for emotional expressiveness, tonal range, and the specific quality of how they carry intimate content. Voice selection is part of the creation flow: you choose the voice that the story will be narrated in, and the narration is generated specifically for your story — not a general recording cut to fit. The voices available include different registers and character qualities. The goal is narration that sounds like someone telling a story, not reading from a script.",
    },
    {
      q: "Can I choose who narrates my story?",
      a: "Yes. Voice choice is one of the selections in the creation flow. You choose the narrator before the story is generated, and the narration is produced specifically for your story in that voice. This means the pacing, the emphasis, and the emotional texture of the narration are calibrated to your narrative rather than being generic.",
    },
    {
      q: "How is listening to audio erotica different from reading erotic fiction?",
      a: "The primary differences are cognitive load and emotional immediacy. Reading keeps part of your attention on the act of reading — decoding text, tracking your position on the page. Audio removes this: the story arrives without effort, and your attention can be fully in the experience rather than partly on the mechanics of receiving it. The voice also carries emotional information that text cannot — the prosodic signals of desire, attention, and feeling that make the character present in a way that words on a page cannot produce. Most listeners who have used both find audio significantly more immersive for erotic content specifically.",
    },
    {
...
export const eroticAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
    ...
    { q: "How are stories created?", a: "Stories are written from scratch around your creation choices, then narrated to a high standard. The result is original fiction — not retrieved from a pre-existing library — with narration suited to the register of the story." },
    { q: "How long are erotic audio stories?", a: "Typically around 10 minutes, depending on voice selection — sized for the specific listening window when adult audio fiction is most wanted — a complete experience without requiring a multi-hour commitment." },
...
export const adultBedtimeStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
    ...
    { q: "How long are adult bedtime stories?", a: "Typically around 10 minutes, depending on voice selection — sized for the specific pre-sleep window — a complete, satisfying experience that doesn't require staying awake for an hour." },
  ],
};
...
export const aiRomanceStoriesForWomenConfig: SEOPageConfig = {
  ...
  faqs: [
    ...
    { q: "How long are AI romance stories?", a: "Typically around 10 minutes, depending on voice selection — sized for the specific listening window when romance fiction is most wanted — the wind-down hour, time alone, the pre-sleep session." },
  ],
};
...
export const eroticAudioStoriesForWomenConfig: SEOPageConfig = {
  ...
  sections: [
    {
      h2: "The Craft of Erotic Fiction That Actually Works for Women",
      paragraphs: [
    ...
    {
      h2: "What Stories Give Female Listeners That Clips Cannot",
      paragraphs: [
    ...
    {
      h2: "Story Specificity — Why Generation Changes the Experience",
      paragraphs: [
  ...
  scenarios: {
    h2: "Stories with Character, History, and Narrative Weight",
    intro: "These four scenarios are specific to erotic audio stories — they are built around character, narrative arc, and the tension that only a story (not a clip) can carry. Each is distinct from the register-based scenarios on the audio erotica page.",
    items: [
      {
        heading: "The Former Colleagues — a story with history",
        body: "They worked together for two years in an environment that required containing what was there. The professional context had its own logic — maintaining it was a choice both made, repeatedly, without discussing it. Now the context has changed. The conversation is different. The dynamic they practiced for two years is still present, and beneath it is everything they were practicing not to do. A story driven by history rather than surprise, by the specific weight of something that was there all along.",
      },
      {
        heading: "The Late Night Conversation That Becomes More",
        body: "It begins as a conversation at an hour when honesty costs less. The voice on the other end asks questions that are actually about something. Intimacy builds not through action but through being asked the right things, through being listened to in the way that makes you feel genuinely known rather than merely heard. The story is about the shift — the narrowing of the distance between what the conversation is nominally about and what it has become. A story driven by voice and attention and the specific charge of being known.",
      },
      {
        heading: "The Professional Who Stops Being Professional",
        body: "The restraint has been entirely deliberate. The dynamic between two people working in proximity, both maintaining appropriate distance because the alternative has obvious complications — and the specific weight of that sustained restraint. The appeal is not the breaking of a rule. It is the particular quality of desire that was powerful enough to be held against for an extended period, now at a moment when the professional context is gone and the reasons for restraint no longer hold. The professionalism made the wanting more precise. <a href=\"/forbidden-romance-audio-stories\">Explore forbidden romance audio stories</a>.",
      },
      {
        heading: "The Unexpected Return — old desire, new context",
    ...
    interstitial: "These are narrative orientations, not fixed plots. Your creation choices shape the specific characters, dynamic, and emotional register of the story generated for you.",
  },
  benefits: {
  ...
  faqs: [
    {
      ...
      a: "Long enough for the tension arc to build and resolve properly — this is not a clip platform. Stories are complete narrative pieces designed for a single listening session: they have an opening, a build, and a resolution that the story earned. The specific length reflects your creation choices and the natural arc they produce. The point is that the build exists — and for the build to work, the story needs real duration.",
    },
    {
      q: "Do the stories have a beginning, middle, and end — or are they just a scene?",
      a: "Full narrative structure: setup, build, and resolution. The arc is the point. Each story begins with the characters in a specific situation, establishes who they are and what exists between them, builds through the specific dynamic you described, and resolves in a way that the narrative has earned. This is what distinguishes a story from a clip — not just length, but whether the narrative has actually built to something.",
    },
    {
      q: "How does my brief shape the character's voice and behaviour in the story?",
      a: "The creation choices you make — the dynamic, the character archetype, the emotional register, the chemistry type, the setting — become the specific brief from which the story is written. The character's manner of speaking, the quality of their attention, how they move through the dynamic with you — all of this reflects what you specified. A character with assured, direct energy is written differently from a character whose desire is restrained and building. The brief determines these qualities from the first paragraph.",
    },
    {
      q: "Are darker themes available — power dynamics, control, morally complex scenarios?",
...
export const eroticAudiobooksForWomenConfig: SEOPageConfig = {
  ...
  fullPicture: {
    ...
    paragraphs: [
      ...
      "The listener who knows what she wants and has not been able to find it in any catalogue is the listener this platform was built for. The Creation Room is the place where the story that does not yet exist gets described — and then created.",
  ...
  faqs: [
    ...
    { q: `How explicit is the content?`, a: `The full spectrum is available, from emotionally charged slow burn through steamy to fully explicit adult fiction. Intensity is one of the seven choices you make in the Creation Room before the story is created — the story is calibrated around what you selected. The After Dark tier removes all content restrictions for intensity. All explicit content requires age verification (18+).` },
    { q: `How long is a typical audio story?`, a: `Stories run to around 10 minutes, depending on voice selection — long enough to build properly, short enough to be a complete listening experience in a session. Erotic audio fiction designed for adults with full lives who want the experience to be complete and unhurried without being a significant time commitment.` },
    ...
    { q: `What is the difference between erotic audiobooks and audio erotica?`, a: `The terms are used interchangeably in common usage, but there is a meaningful distinction. An erotic audiobook follows the audiobook format: a pre-written, professionally produced work of erotic fiction narrated for listening, available for purchase or subscription. Audio erotica is the broader category of erotic content delivered through audio — which includes audiobooks, guided audio, and generative platforms. At The Private Story, what you receive is neither: it is original erotic fiction generated for this session, around your specific brief, narrated in studio-quality audio. It has the form of an audiobook but the origin of something entirely different.` },
    { q: `Can I choose the characters and setting?`, a: `Yes. The Creation Room allows you to specify the pairing type, the chemistry between the characters (nine options including slow burn, power play, and forbidden pull), the character archetype (14 options), the setting (50+ countries, 12 historical periods, or After Dark worlds), the emotional mood (28 options), and the specific situation (220 situations across 11 dramatic categories). The story is built around exactly what you describe — not a general interpretation of it.` },
  ],
};
...
export const steamyAudioStoriesConfig: SEOPageConfig = {
  ...
  faqs: [
    ...
    { q: `Is steamy the same as soft erotica?`, a: `Soft erotica is often used to describe content that is mildly erotic in character — restrained, suggestive, not explicitly stated. Steamy is a distinct category that describes a specific temperature register: warm, charged, desire-present throughout, building toward something rather than arriving at it. A steamy story is genuinely erotic in atmosphere — the imagination is engaged, the tension is real — it simply does not rush to its explicit expression. It is not a diluted or restrained version of erotica; it is its own creative register with its own appeal.` },
    { q: `Can a steamy story have an explicit ending?`, a: `Yes. Steamy describes the dominant register and temperature of the story rather than whether it has any explicit content at all. A story can build in the warm, charged steamy register and arrive at a fully explicit resolution — many of the most effective stories in this territory work exactly this way. Alternatively, the steamy register can hold throughout without explicit arrival, trusting the listener's imagination to complete what the story sets up. In the Creation Room, you can set both the overall intensity and the mood, which together shape whether the story resolves explicitly or holds at the charged approach.` },
    { q: `What kinds of steamy stories can I request?`, a: `Any genre or scenario at the steamy register. Steamy forced proximity, where the warmth builds within the shared space. Steamy dark romance, where the charged register sits within morally complex dynamics. Steamy slow burn, where the accumulation is extended and the approach is long. Steamy office romance, where the professional constraint contains the warmth. Steamy forbidden romance, where the pull is real but the cost is present throughout. The steamy register is a temperature that can be applied to any genre or scenario — you choose the genre, the situation, and the characters, and set steamy as the intensity.` },
  ],
};
...
export const aiEroticaConfig: SEOPageConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Good AI erotica begins with a genuinely specific brief: a structured series of choices that give the generation model enough precise direction to produce something that is actually particular to this listener, this session, this emotional territory. The Creation Room at The Private Story is built around this principle — the seven choices it asks for are not generic preferences but specific directions that collectively define a creative brief detailed enough to generate something worth listening to.",
  ...
  fullPicture: {
    ...
    paragraphs: [
      ...
      "The Private Story is built at the quality end of this spectrum. The creative brief — the choices made in the Creation Room before anything is generated — is the mechanism through which specificity is achieved. The literary calibration of the generation is the mechanism through which quality is maintained. The audio production is the mechanism through which the experience is something worth actually listening to. And the privacy architecture is the mechanism through which the listener can explore her full imagination without the compromise of a social infrastructure that was not designed for this.",
