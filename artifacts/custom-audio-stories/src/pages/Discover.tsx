...
const CLUSTERS = [
  ...
  },
  {
    ...
    pages: [
      ...
      { label: "Dipsea alternative", href: "/dipsea-alternative", tagline: "A personalised practice that sits alongside Dipsea" },
      { label: "Quinn alternative", href: "/quinn-alternative", tagline: "A different door into the same room as Quinn" },
      { label: "Ferly alternative", href: "/ferly-alternative", tagline: "Generative storytelling alongside Ferly's mindful library" },
      { label: "GoneWildAudio alternative", href: "/gonewildaudio-alternative", tagline: "A private, narrated alternative to community audio" },
    ],
  },
  {
    ...
    pages: [
      ...
      { label: "Erotica for couples", href: "/audio-erotica-for-couples", tagline: "Stories shaped to listen to together" },
      { label: "Erotica for women over 30", href: "/audio-erotica-for-women-over-30", tagline: "Written for the listener who knows what she wants" },
      { label: "Personalised erotica", href: "/personalised-erotica", tagline: "Generated around your brief — not selected from a library" },
      { label: "AI erotica", href: "/ai-erotica", tagline: "An AI that writes your story, not just a story" },
      { label: "Short erotic audio stories", href: "/short-erotic-audio-stories", tagline: "Ten minutes, made for tonight" },
      { label: "Erotica with male narrator", href: "/audio-erotica-with-male-narrator", tagline: "Cast a male voice for your story" },
      { label: "British male voice erotica", href: "/audio-erotica-male-voice-british", tagline: "British male narration, made for you" },
      { label: "British erotica for women", href: "/british-audio-erotica-for-women", tagline: "British literary erotica, privately generated" },
      { label: "Audio erotica UK", href: "/audio-erotica-uk", tagline: "Made in the UK, narrated for UK listeners" },
      { label: "Best UK audio erotica app", href: "/best-audio-erotica-app-uk", tagline: "What to look for in a UK platform" },
      { label: "Lesbian audio erotica", href: "/lesbian-audio-erotica", tagline: "Stories created around lesbian listeners and couples" },
      { label: "Queer audio erotica", href: "/queer-audio-erotica", tagline: "Generated, private, written for queer listeners" },
      { label: "How to listen — a guide", href: "/how-to-listen-to-audio-erotica", tagline: "Headphones, settings, voice choice — a practical guide" },
      { label: "For beginners", href: "/audio-erotica-for-beginners", tagline: "A first listen, made for you" },
    ],
  },
];
