 ...
 *
 * Transcripts are the verbatim audio scripts — kept in sync with
 * artifacts/api-server/scripts/generate-editors-picks.mjs.
 */
...
export interface EditorsPick {
  ...
  runtimeSec: number;
  /** Full transcript shown when the reader reveals it (verbatim audio script). */
  transcript: string;
}
...
export const EDITORS_PICKS: EditorsPick[] = [
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 130,
    transcript: `"You're still here," he said.
...
He found the zip at the side of her dress — certain, unhurried, the hands of a man who had been told yes — and she felt the cool air and then the warmth of his palms and stopped thinking about anything except this.`,
  },
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 140,
    transcript: `"This is going to sound — I genuinely have run out of corkscrews. Do you have one I can borrow," she said.
...
"Don't stop," she said.`,
  },
  {
    ...
    pairing: "Her & Her",
    runtimeSec: 130,
    transcript: `"You're tense," the woman said quietly.
...
She wrapped one hand in the woman's hair and told her exactly what she wanted next.`,
  },
  {
    ...
    pairing: "Her & Him & Him",
    runtimeSec: 140,
    transcript: `"Right," he said finally. "The bedroom is yours. We'll work it out down here."
...
They didn't answer. They didn't need to.`,
  },
  {
    ...
    pairing: "Her & Him & Him",
    runtimeSec: 135,
    transcript: `"We were going to come and ask if you wanted a nightcap," one of them said.
...
Her gown had a zip at the side. She reached back, found a hand, and guided it there herself.`,
  },
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 145,
    transcript: `"I think I locked my key in the room," she said.
...
He came to her.`,
  },
  {
    ...
    pairing: "Her & Her",
    runtimeSec: 135,
    transcript: `"You came back," her supervisor said.
...
Her mouth on her throat. She stopped being able to be still at all.`,
  },
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 140,
    transcript: `"You can stand somewhere else," she said.
...
She had six weeks of corners to work through. She intended to take her time.`,
  },
  {
    ...
    pairing: "Her & Him",
    runtimeSec: 130,
    transcript: `"From the gentleman," the waiter said.
...
export const VOICES_META: Array<{
  ...
  { key: "theo",  name: "Theo",  oneLine: "British. Measured, unhurried, present." },
];
